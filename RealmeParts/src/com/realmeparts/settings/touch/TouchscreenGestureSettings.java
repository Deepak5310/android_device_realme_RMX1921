...
import com.android.internal.awaken.hardware.LineageHardwareManager; // Need FWB support
import com.android.internal.awaken.hardware.TouchscreenGesture; // Need FWB support
    ...
    public static class MainSettingsFragment extends PreferenceFragment {
        ...
        private Preference.OnPreferenceChangeListener mHapticPrefListener =
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                if (KEY_HAPTIC_FEEDBACK.equals(key)) {
                    ...
                    Utils.putInt(getContext(), KEY_HAPTIC_FEEDBACK, value ? 1 : 0);
                    return true;
                }
                return false;
            }
        ...
        public void onResume() {
            ...
            mHapticFeedback.setChecked(
                    Utils.getInt(getContext(), KEY_HAPTIC_FEEDBACK, 1) != 0);
        }
